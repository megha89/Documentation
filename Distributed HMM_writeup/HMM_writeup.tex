...
\and
\IEEEauthorblockN{Dr. Haimonti Dutta}
...
% no \IEEEPARstart
Aggregation is a process in which data is gathered and used for statistical analysis. The purpose of energy aggregation is to get some valuable information about single or multi-site units. In this paper, we 
