...
\begin{figure*}[ht]
\centering
\epsfig{file=o_e.eps, height= 1.8 in,width= 5.0 in}
\label{fig:o_e}
\epsfig{file=b_h.eps, height= 1.8 in,width= 5 in}
\label{fig:b_h}
\epsfig{file=u_n.eps, height= 1.8 in,width= 5 in}
\label{fig:u_n}
\epsfig{file=I_i.eps, height= 1.8 in,width= 5 in}
\label{fig:I_i}
\epsfig{file=l_i.eps, height= 1.8 in,width= 5 in}
\label{fig:l_i}
\caption{Examples of character level corrections}
\end{figure*}
